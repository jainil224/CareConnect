            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className="w-full bg-[#121212] border-none rounded-xl h-11 px-4 text-white placeholder:text-white/20 focus:ring-2 focus:ring-white/20 focus:outline-none transition-all pr-12"
                />
                <button
                  type="button"
...
function StepItem({ number, text, active = false }) {
  return (
    <div className={`flex items-center space-x-3 p-3 rounded-xl transition-colors duration-300 ${
      active ? "bg-white text-black border border-white" : "bg-[#121212] text-white border border-transparent"
    }`}>
...
function InputGroup({ label, type, name, placeholder, value, onChange }) {
  return (
    <div className="space-y-1">
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className="w-full bg-[#121212] border-none rounded-xl h-11 px-4 text-white placeholder:text-white/20 focus:ring-2 focus:ring-white/20 focus:outline-none transition-all"
      />
    </div>
  );
}
